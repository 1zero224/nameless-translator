...
export const getGetConfigResponsePipelineConfigMock = (
  ...
  ...{
    ...
    repairer: faker.string.alpha({ length: { min: 10, max: 20 } }),
...
export const getGetEngineCatalogResponseMock = (
  ...
  repairers: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(
    () => ({
      id: faker.string.alpha({ length: { min: 10, max: 20 } }),
      name: faker.string.alpha({ length: { min: 10, max: 20 } }),
      produces: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(
...
export const getListProjectsResponseMock = (
  ...
  projects: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(
    () => ({
      coverUrl: faker.helpers.arrayElement([
        faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), null]),
        undefined,
      ]),
      id: faker.string.alpha({ length: { min: 10, max: 20 } }),
      name: faker.string.alpha({ length: { min: 10, max: 20 } }),
      pageCount: faker.helpers.arrayElement([faker.number.int({ min: 0 }), undefined]),
      path: faker.string.alpha({ length: { min: 10, max: 20 } }),
      textBlockCount: faker.helpers.arrayElement([faker.number.int({ min: 0 }), undefined]),
...
export const getGetProjectCoverResponseMock = (): ArrayBuffer =>
  new ArrayBuffer(faker.number.int({ min: 1, max: 64 }))
...
export const getGetSceneJsonResponseFontWorkflowTraceMock = (
  overrideResponse: Partial<FontWorkflowTrace> = {},
): FontWorkflowTrace => ({
  ...{
    candidateFonts: faker.helpers.arrayElement([
      Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() =>
        faker.string.alpha({ length: { min: 10, max: 20 } }),
      ),
      undefined,
    ...
    primaryCategory: faker.helpers.arrayElement([
      faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), null]),
      undefined,
    ]),
    secondaryCategory: faker.helpers.arrayElement([
      faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), null]),
      undefined,
    ]),
    selectedFont: faker.helpers.arrayElement([
      faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), null]),
      undefined,
    ]),
  },
...
export const getGetSceneJsonResponseRepairWorkflowTraceMock = (
  overrideResponse: Partial<RepairWorkflowTrace> = {},
): RepairWorkflowTrace => ({
  ...{
    error: faker.helpers.arrayElement([
      faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), null]),
    ...
    sourceMask: faker.helpers.arrayElement([
      faker.helpers.arrayElement([null, faker.string.alpha({ length: { min: 10, max: 20 } })]),
      undefined,
    ]),
  },
  ...overrideResponse,
...
export const getGetSceneJsonResponseTextSelectionMock = (
  overrideResponse: Partial<TextSelection> = {},
): TextSelection => ({
  ...{
    shapes: faker.helpers.arrayElement([
      Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() =>
        faker.helpers.arrayElement([
          {
            kind: faker.helpers.arrayElement(['rectangle'] as const),
            transform: {
              height: faker.number.float({ fractionDigits: 2 }),
          ...
          {
            kind: faker.helpers.arrayElement(['brush'] as const),
            mask: faker.string.alpha({ length: { min: 10, max: 20 } }),
          },
          {
            kind: faker.helpers.arrayElement(['polygon'] as const),
            points: Array.from(
              { length: faker.number.int({ min: 1, max: 10 }) },
              (_, i) => i + 1,
            ).map(() =>
            ...
            kind: faker.helpers.arrayElement([
              ...
              },
              {
                text: {
                  ...
                  workflow: faker.helpers.arrayElement([
                    {
                      fontTrace: faker.helpers.arrayElement([
                        faker.helpers.arrayElement([
                          null,
                          { ...getGetSceneJsonResponseFontWorkflowTraceMock() },
                        ]),
                        undefined,
                      ]),
                      letteringStatus: faker.helpers.arrayElement([
                        faker.helpers.arrayElement(Object.values(WorkflowStatus)),
                        undefined,
                      ]),
                      modes: faker.helpers.arrayElement([
                        faker.helpers.arrayElements(Object.values(TextWorkflowMode)),
                        undefined,
                      ]),
                      repairLayer: faker.helpers.arrayElement([
                        faker.helpers.arrayElement([null, faker.string.uuid()]),
                        undefined,
                      ]),
                      repairStatus: faker.helpers.arrayElement([
                        faker.helpers.arrayElement(Object.values(WorkflowStatus)),
                        undefined,
                      ]),
                      repairTrace: faker.helpers.arrayElement([
                        faker.helpers.arrayElement([
                          null,
                          { ...getGetSceneJsonResponseRepairWorkflowTraceMock() },
                        ]),
                        undefined,
                      ]),
                      resultMode: faker.helpers.arrayElement([
                        faker.helpers.arrayElement(Object.values(TextResultMode)),
                        undefined,
                      ]),
                      selection: faker.helpers.arrayElement([
                        faker.helpers.arrayElement([
                          null,
                          { ...getGetSceneJsonResponseTextSelectionMock() },
                        ]),
                        undefined,
                      ]),
                    },
...
export const getGetProjectCoverMockHandler = (
  overrideResponse?:
    | ArrayBuffer
    | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<ArrayBuffer> | ArrayBuffer),
  options?: RequestHandlerOptions,
