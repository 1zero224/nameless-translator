...
export const useCreatePagesFromPaths = <TError = unknown,
 ...
 , queryClient?: QueryClient): UseMutationResult<
  ...
  return stringifiedParams.length > 0 ? `/api/v1/pages/${id}/image-layers?${stringifiedParams}` : `/api/v1/pages/${id}/image-layers`
}

export const addImageLayer = async (id: PageId,
    params?: AddImageLayerParams, options?: RequestInit): Promise<AddImageLayerResponse> => {

  return fetchApi<AddImageLayerResponse>(getAddImageLayerUrl(id,params),
  {
    ...options,
    method: 'POST'
...
export const getAddImageLayerMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof addImageLayer>>, TError,{id: PageId;params?: AddImageLayerParams}, TContext>, request?: SecondParameter<typeof fetchApi>}
): UseMutationOptions<Awaited<ReturnType<typeof addImageLayer>>, TError,{id: PageId;params?: AddImageLayerParams}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof addImageLayer>>, {id: PageId;params?: AddImageLayerParams}> = (props) => {
          const {id,params} = props ?? {};

          return  addImageLayer(id,params,requestOptions)
        }
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TError,
        {id: PageId;params?: AddImageLayerParams},
        TContext
      > => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
 ...
 , queryClient?: QueryClient): UseMutationResult<
    ...
    export const getGetProjectCoverUrl = (id: string,) => {




  return `/api/v1/projects/${id}/cover`
}

export const getProjectCover = async (id: string, options?: RequestInit): Promise<Blob> => {

  return fetchApi<Blob>(getGetProjectCoverUrl(id),
  {
    ...options,
    method: 'GET'
...
export const getGetProjectCoverQueryKey = (id: string,) => {
    return [
...
export const getGetProjectCoverQueryOptions = <TData = Awaited<ReturnType<typeof getProjectCover>>, TError = unknown>(id: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getProjectCover>>, TError, TData>>, request?: SecondParameter<typeof fetchApi>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetProjectCoverQueryKey(id);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getProjectCover>>> = ({ signal }) => getProjectCover(id, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: id !== null && id !== undefined,  gcTime: 300000, retry: 1,  ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getProjectCover>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type GetProjectCoverQueryResult = NonNullable<Awaited<ReturnType<typeof getProjectCover>>>
export type GetProjectCoverQueryError = unknown


export function useGetProjectCover<TData = Awaited<ReturnType<typeof getProjectCover>>, TError = unknown>(
 id: string, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof getProjectCover>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof getProjectCover>>,
          TError,
          Awaited<ReturnType<typeof getProjectCover>>
        > , 'initialData'
      >, request?: SecondParameter<typeof fetchApi>}
...
export function useGetProjectCover<TData = Awaited<ReturnType<typeof getProjectCover>>, TError = unknown>(
 id: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getProjectCover>>, TError, TData>>, request?: SecondParameter<typeof fetchApi>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export function useGetProjectCover<TData = Awaited<ReturnType<typeof getProjectCover>>, TError = unknown>(
 ...
 , queryClient?: QueryClient
  ...
  const queryOptions = getGetProjectCoverQueryOptions(id,options)
