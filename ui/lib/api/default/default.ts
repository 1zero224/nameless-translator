...
export const getAddImageLayerUrl = (id: PageId, params?: AddImageLayerParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/v1/pages/${id}/image-layers?${stringifiedParams}`
    : `/api/v1/pages/${id}/image-layers`
}
...
export const getGetProjectCoverQueryKey = (id: string) => {
  return [`/api/v1/projects/${id}/cover`] as const
}

export const getGetProjectCoverQueryOptions = <
  TData = Awaited<ReturnType<typeof getProjectCover>>,
  TError = unknown,
>(
  id: string,
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getProjectCover>>, TError, TData>>
    request?: SecondParameter<typeof fetchApi>
  },
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {}
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getProjectCover>>> = ({ signal }) =>
    getProjectCover(id, { signal, ...requestOptions })
  ...
  return {
    ...
    retry: 1,
    ...queryOptions,
  } as UseQueryOptions<Awaited<ReturnType<typeof getProjectCover>>, TError, TData> & {
    queryKey: DataTag<QueryKey, TData, TError>
  }
}
...
export function useGetProjectCover<
  TData = Awaited<ReturnType<typeof getProjectCover>>,
  TError = unknown,
>(
  id: string,
